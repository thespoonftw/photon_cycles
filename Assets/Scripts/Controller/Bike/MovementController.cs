...
public class MovementController
{
    ...
    private readonly LayerMask groundMask = LayerMask.GetMask("Default");
    private readonly LayerMask trailMask = LayerMask.GetMask("Trail");
    private readonly IInputController input;
    private readonly Transform transform;

    public MovementController(IInputController input, Transform transform)
    {
        this.input = input;
